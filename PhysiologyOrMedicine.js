let link =
  "https://masterdataapi.nobelprize.org/2.1/laureates?offset=0&limit=50";
let count = 1;

async function PhysiologyOrMedicine() {
  await fetch(link)
    .then((res) => res.json())
  ...
  function initialize(data) {
    ...
    array.forEach((element) => {
      if (element.nobelPrizes[0].category.en === "Physiology or Medicine") {
